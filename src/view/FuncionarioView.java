...
public class FuncionarioView {
	//ATRIBUTOS(inicio):
		...
		private String [] Funcionarios = {"--Escolha uma opção--","Professor", "Secretaria","Faxineira"};
		//ATRIBUTOS(FIM)
		...
		public void iniciarGui() {//iniciar metodo iniciarGui
			...
			lblInfoBasicas.setText("REGISTRO DE FUNCIONÁRIO");
			...
			lblSexo.setText("*Sexo do funcionário: ");
...
//			jpwSenha.setBackground(Color.LIGHT_GRAY);
			...
			lblInfoEndereco.setText("ENDEREÇO DO FUNCIONARIO");
...
//			campoUf.setBackground(Color.LIGHT_GRAY);
			...
			btnSalvar.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(cboxTipo.getSelectedItem().toString() == "--Escolha uma opção--") {
						id = "0";
